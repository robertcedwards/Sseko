...
<script> var ADAPT_CONFIG = {path: '<?php bloginfo('template_directory'); ?>/_/js/css/' , dynamic: true, range:['0px  to 980px  = 720.css','980px  to 1280px = 960.css','1280px to 5000px = 1200.css',]};</script> 
	...
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/_/js/ui.css">
		...
		<header>
			...
			<div id="description" class="grid_5">
        		...
        		<div id="inside">
        			...
        			<span><a id="login" href="http://shop.ssekodesigns.com/orders.php">login </a>//</span>
        			<span>  
					<a href="http://shop.ssekodesigns.com/cart.php">Cart (0)</a>
  					</span>
  				</div>	
        	</div>
     		 <div id="shipping" class="grid_4">
        		<div id="inside">
        			...
        			<span id="returns"><a href="http://shop.ssekodesigns.com/pages.php?pageid=7">shipping & returns info</a></span>
        		</div>
			</div>
			<div class="clear"></div> 	

			<div class="grid_9 nav omega">

	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<article  id="post-<?php the_ID(); ?>">
				...
				<div class="grid_4 notes">
					...
					<br />
					<div class="meetnote"><p>Our veteran team members work for Sseko full-time, year round. From mothers to managers, read about the dreams each of these women is working towards. </p>
</div>
				</div>

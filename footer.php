...
<script type="text/javascript">$(document).ready(function() {$("a.img.attachment-thumbnail").fancybox({'hideOnContentClick': true , 'autoScale' : true , 'autoDimensions' : true });});</script>

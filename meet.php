	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<article  id="post-<?php the_ID(); ?>">
				...
				<a class="grid_4 alpha" href="/university-bound" alt="University Bound">
					<img src="http://sseko.welovewebsit.es/wp-content/uploads/2011/11/0u.png" alt="University Bound" title="University Bound" class="grid_4" />
				...
				<img title="Full Time Veteran" src="http://sseko.welovewebsit.es/wp-content/uploads/2011/11/0s.png" alt="Full Time Veterans" title="Full Time Veterans"class="grid_4" />
				...
				<img title="Sseko Graduates" alt="Sseko Graduates" src="http://sseko.welovewebsit.es/wp-content/uploads/2011/11/0t.png" class="grid_4"alt="" />

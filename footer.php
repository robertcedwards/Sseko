...
<script type="text/javascript">$(document).ready(function() {$("img.attachment-thumbnail").fancybox({'hideOnContentClick': true , 'autoScale' : true , 'autoDimensions' : true });});</script>
